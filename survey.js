...
async function submitSurvey(event) {
    ...
    try {
        ...
        // Save to localStorage (for static site deployment)
        const allResponses = loadFromLocalStorage('surveyResponses') || [];
        allResponses.push(submissionData);
        saveToLocalStorage('surveyResponses', allResponses);
